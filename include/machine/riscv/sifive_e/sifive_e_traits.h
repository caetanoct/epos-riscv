...
template<> struct Traits<Machine>: public Traits<Machine_Common>
{
    ...
    static const unsigned int MEM_TOP           = 0x87ffffff;   
    ...
    static const unsigned int BOOT_STACK        = 0x80fffffc;

    // Logical Memory Map
    static const unsigned int BOOT              = NOT_USED;     
    static const unsigned int IMAGE             = 0x87000000;   
    static const unsigned int SETUP             = 0x80000000;   
    static const unsigned int INIT              = 0x87f00000;   

    static const unsigned int APP_LOW           = 0x80400000;   
    static const unsigned int APP_HIGH          = 0xdfffffff;   

    static const unsigned int PHY_MEM           = 0x20000000;   
    static const unsigned int IO                = 0x00000000;
    static const unsigned int SYS               = 0xff800000;   
